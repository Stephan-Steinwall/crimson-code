    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          {/* Logo Placeholder */}
          <div className="h-10 w-32 bg-gray-200/50 rounded-lg flex items-center justify-center font-bold">
            LOGO
          </div>
        ...
        {/* Mobile Menu */}
        <div
          className={`md:hidden absolute top-full left-0 right-0 bg-white/80 backdrop-blur-lg transition-all duration-300 ${
